...
const TaskList = () => {
  ...
  return (
    <div className="p-6 w-full mx-auto space-y-4 h-[70vh] overflow-auto ">
      {tasksData.map((task, index) => (
        <div key={index} className=" ">
          <div className="border-2 text-white p-4 rounded-lg shadow-md flex flex-col md:flex-row gap-6">
